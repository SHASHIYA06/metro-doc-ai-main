                        ...
                        try {
                          ...
                          for (const content of fileContents) {
                            try {
                              ...
                              // For content generated by frontend (structured text), use text/plain MIME type
                              // This prevents the backend from trying to parse it as a binary file
                              const isGeneratedContent = content.content.includes('DOCUMENT INFORMATION:') ||
                                                       ...
                                                       content.content.includes('SUGGESTED QUERIES:');
